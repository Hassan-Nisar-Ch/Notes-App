...
- Local persistence (db package) for offline access
- Clean, maintainable architecture with clear layers (data / db / presentation / di / util)
- Kotlin + Android XML layouts for predictable UI structure
- Lightweight, easy to extend and customize
